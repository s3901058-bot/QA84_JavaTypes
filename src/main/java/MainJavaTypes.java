...
Теперь str str1 str2 указывают на "Hello"
 */
        String str2 = str1;
 ...
 /*
String в Java неизменяемый "Hello" не меняется Переменная str просто начинает ссылаться на новый объект "Bay"
*/
        str = "Bay";
        /*
str2 теперь тоже начинает ссылаться туда же куда str То есть str2 теперь указывает на "Bay"
 */
        str2 = str;
 ...
 /*
 str1 больше ни на что не ссылается null = отсутствие ссылки на объект
